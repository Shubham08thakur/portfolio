        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end animate-fade-in">
            <div className="relative">
              <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-purple-500 to-purple-700 blur-lg opacity-30"></div>
              <div className="relative overflow-hidden rounded-xl border border-gray-800 bg-dark-100">
                <img 
