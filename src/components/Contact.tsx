            ...
            <div className="card p-6">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-dark-300 flex items-center justify-center text-white hover:bg-purple-500 transition-colors"
                >
          ...
          <div className="lg:col-span-2">
            <div className="card p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className="bg-dark-300 border-gray-700 text-white placeholder:text-gray-500 focus-visible:ring-purple-500"
                    />
                  </div>
                ...
                <div>
                  <label htmlFor="subject" className="text-sm font-medium text-gray-300 mb-1 block">
                    Subject
                  </label>
                  <Input
                    id="subject"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    required
                    className="bg-dark-300 border-gray-700 text-white min-h-32 placeholder:text-gray-500 focus-visible:ring-purple-500"
                  />
                </div>
